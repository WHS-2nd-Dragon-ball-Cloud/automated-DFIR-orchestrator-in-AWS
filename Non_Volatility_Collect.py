...
def lambda_handler(event, context):
    ...
    try:
        ...
        directory_check_result, error_output = execute_command_and_wait(ssm, backup_instance_id,
        ...
        for file_name in forensic_files_to_upload:
            ...
            if file_check_result:
                ...
                logging.info(
                    f"Uploading file {file_path} to s3://{forensic_collect_bucket}/{instance_id}/{timestamp}/non_volatility_data/{file_name}")
                ...
                logging.info(
                    f"Uploading hash file {hash_file_path} to s3://{forensic_collect_bucket}/{instance_id}/{timestamp}/non_volatility_data/{file_name}.sha256")
